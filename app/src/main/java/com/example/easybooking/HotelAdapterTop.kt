...
import com.example.easybooking.Hotel
import com.example.easybooking.R

class HotelAdapterTop(private val hotels: List<Hotel>, private val listener: HotelItemClickListener) :


    RecyclerView.Adapter<HotelAdapterTop.HotelViewHolder>() {
